...
const DatePicker: React.FC<DatePickerProps> = ({ name, value, onChange, required = false }) => {
    ...
    return (
      <div className="absolute top-full left-0 mt-2 bg-white rounded-2xl shadow-2xl border border-career-lightGray/50 p-4 z-50 w-80 animate-fade-in">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          >
            <svg className="w-5 h-5 text-career-darkGreen" fill="none" stroke="currentColor" viewBox="0 0 24 24">
