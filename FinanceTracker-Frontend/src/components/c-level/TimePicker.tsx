...
const TimePicker: React.FC<TimePickerProps> = ({ name, value, onChange, required = false }) => {
      ...
      {showPicker && (
        <div className="absolute top-full left-0 mt-2 bg-white rounded-2xl shadow-2xl border border-career-lightGray/50 p-4 z-50 w-72 animate-fade-in">
          ...
          <div className="text-center mb-4">
            <h3 className="text-lg font-bold text-career-darkGreen">Select Time</h3>
          ...
          <div className="flex gap-2 mb-4">
            ...
            <div className="flex-1">
              <div className="text-xs font-semibold text-gray-500 text-center mb-2">Hour</div>
            ...
            {/* Minutes */}
            <div className="flex-1">
              <div className="text-xs font-semibold text-gray-500 text-center mb-2">Minute</div>
