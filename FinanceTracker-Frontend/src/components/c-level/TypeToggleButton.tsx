...
const TypeToggleButton: React.FC<TypeToggleButtonProps> = ({ type, selectedType, onClick }) => {
    ...
    <button
      ...
      className={`
        ...
        ${isSelected
          ...
          : 'bg-gray-50 border-gray-200 text-gray-600 ' + (isExpense ? 'hover:border-red-300' : 'hover:border-green-300')
        }
      `}
    >
