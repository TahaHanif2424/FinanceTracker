...
const TransactionDetail: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-r from-career-darkGreen to-career-mediumGreen p-4">
        ...
        <div className="p-4">
          ...
          {/* Action Buttons */}
          <div className="flex gap-2 mt-4 pt-4 border-t border-career-lightGray/50">
            <button
              type="button"
              className="flex-1 px-4 py-2 rounded-xl font-semibold text-sm bg-career-darkGreen text-white hover:bg-career-mediumGreen transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-1.5"
            >
            ...
            <button
              type="button"
              className="flex-1 px-4 py-2 rounded-xl font-semibold text-sm bg-red-500 text-white hover:bg-red-600 transition-all duration-200 shadow-sm hover:shadow-md flex items-center justify-center gap-1.5"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
